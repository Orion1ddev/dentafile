...
export const CalendarView = () => {
  ...
  return <div className="w-full max-w-[2000px] pt-4 mx-0 px-[29px] py-0">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        <Card className="p-4 lg:col-span-4 overflow-hidden bg-secondary">
          ...
          }} events={calendarEvents} eventClick={handleDateSelect} height={isMobile ? "500px" : "800px"} slotMinTime="08:00:00" slotMaxTime="24:00:00" weekends={true} allDaySlot={false} slotDuration="00:30:00" firstDay={1} locale={language} buttonText={{
